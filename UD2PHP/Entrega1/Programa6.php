...
echo "<br>Mostramos variable no definida antes de desactivar errores :$entero";  // Notice: Undefined variable: entero

// Oculta todos los warnings (aunque se sigan generando internamente)
error_reporting(0);// 7 mostramos variable No definida
echo "<br>Mostramos variable no definida despues de desactivar entero :$entero";  // Notice: Undefined variable: entero
